          ...
          <div className={`${isDarkMode ? 'bg-blue-800 border-blue-700' : 'bg-white border-blue-100'} border shadow-2xl rounded-t-[2.5rem] w-full max-w-4xl p-6`}>
            ...
            <div className="grid grid-cols-2 gap-8">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="relative w-10 h-10 overflow-hidden rounded-lg">
                      <Image 
                        ...
                        // loading="lazy" est activé par défaut par Next.js
                      />
                    </div>
              ...
              {compareList.length === 1 && (
                <div className="border-2 border-dashed rounded-2xl flex items-center justify-center text-[10px] font-black opacity-30 uppercase text-center">
